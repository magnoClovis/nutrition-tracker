...
| 19 | C20 | Fechar e calibrar motor de pontuação 0–5 | Parcial — pós-lançamento Beta | Base para C19 e C21; será evoluído publicamente como recurso Beta, sem bloquear o lançamento geral. |
| 20 | C19 | Concluir avaliação de refeição e aceite UX | Parcial — pós-lançamento Beta | Depende de C20; o editor compartilhado de C24 reduz retrabalho. |
