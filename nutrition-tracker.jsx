...
false && showGA && React.createElement("div", {
  style: {
  ...
  React.createElement("div", {
    style: {
      background: darkMode ? "#1f1f1f" : "#fffdf8",
      color: "var(--text2)",
    ...
    /* Ajuste calórico (toler?ncia, pode ser negativo para déficit) */
    React.createElement("div", { style: { marginBottom:12 } },
