...
- **Minutos de CI:** 31 min 27 s na primeira tentativa concluída (leves: 53 s nos runs `36194586853`, `36194586861` e `36194586893`; pesado: 30 min 34 s no run `36194586909`); todos os tempos são de início a atualização terminal dos runs, e os três gates falhos continuam registrados.
