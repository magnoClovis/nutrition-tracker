...
- **Minutos de CI:** 64 min 07 s nas duas tentativas concluídas (leves: 1 min 53 s; pesados: 62 min 14 s), medidos do início à atualização terminal dos runs. A primeira tentativa somou 31 min 27 s (leves 53 s; pesado 30 min 34 s) e falhou; a segunda somou 32 min 40 s (leves 1 min; pesado 31 min 40 s) e passou integralmente.
