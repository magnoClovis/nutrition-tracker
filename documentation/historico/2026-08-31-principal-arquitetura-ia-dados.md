...
- **PRs/commits relacionados:** inventário preparatório no draft PR #258, commit `432b8c6`; base da reconfirmação `origin/main` `859f6fb`; validação administrativa read-only de 26/09/2026. Fontes oficiais para interpretação: [Cloud Tasks `getIamPolicy` exige POST](https://docs.cloud.google.com/tasks/docs/reference/rest/v2/projects.locations.queues/getIamPolicy), [invocação de Functions Gen2 usa Cloud Run IAM](https://docs.cloud.google.com/functions/docs/securing/managing-access-iam) e [permissões Firebase Auth](https://docs.cloud.google.com/iam/docs/roles-permissions/firebaseauth). — **Chat:** Trofia-Principal.
