...
Foi gerado um APK `release` local versionCode 18 para a repetição iterativa, SHA-256 `6B14F780F1E3301B10CE72BF77E6357CE368D96FFE07F7E341716D9F6E84F939`, assinado pela chave de upload. A assinatura do app distribuído pela Play foi verificada separadamente e é diferente, como esperado pelo Play App Signing; por isso a build local não pode atualizar a instalação Play por cima. A estratégia aprovada é desinstalar temporariamente o app Play, instalar o APK release local para as iterações estritamente visuais/nativas e realizar uma única validação final pela Play para assinatura, App Check e distribuição. A repetição física aguarda acesso seguro à conta de testes; nenhuma credencial será recebida por chat ou versionada.

**PRs/commits relacionados:** [PR draft #207](https://github.com/magnoClovis/nutrition-tracker/pull/207), commit inicial [`da9922d`](https://github.com/magnoClovis/nutrition-tracker/commit/da9922d), CI leve [`35014899826`](https://github.com/magnoClovis/nutrition-tracker/actions/runs/35014899826) e CI pesado autenticado [`35014899866`](https://github.com/magnoClovis/nutrition-tracker/actions/runs/35014899866). A correção descoberta na prova física e sua evidência final permanecem pendentes de commit/CI e aprovação no Galaxy.
