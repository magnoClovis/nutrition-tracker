...
- **Data de conclusão:** não concluído.
- **Tempo decorrido:** pendente de merge.
- **Minutos de CI:** 0 min; CI do PR ainda não iniciado.
...
- **PRs/commits relacionados:** PR e commit ainda não criados; o registro será atualizado com os runs autenticados e o merge reais.
