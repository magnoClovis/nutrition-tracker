...
**Minutos de CI:** 0 min; CI real ainda não iniciado.
...
**PRs/commits relacionados:** PR futuro em modo draft; base reconciliada `b9ae9ff`; PRs de precedência #257, #261, #262 e #258; CI real ainda pendente.
