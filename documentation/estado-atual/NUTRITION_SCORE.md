> **Cópia documental — contrato implementado.** Fonte: `/NUTRITION_SCORE.md`, capturada da `main` no commit `5c51fa5` em 31/08/2026. `meal-score-v2` e sua integração C20/C19 estão concluídos; revisões profissionais ou versões futuras continuam planejamento explícito. O original da raiz continua sendo a fonte operacional.
