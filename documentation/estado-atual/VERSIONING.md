> **Cópia documental — conteúdo misto.** Fonte: `/VERSIONING.md`, sincronizada nesta atualização documental em 25/09/2026. Marcos já publicados permanecem históricos; versões posteriores são checkpoints planejados, não funcionalidades disponíveis hoje. O original da raiz continua sendo a fonte operacional.
