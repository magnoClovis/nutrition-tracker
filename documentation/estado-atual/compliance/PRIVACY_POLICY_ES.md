> **Copia documental — política pública vigente.** Fuente: `/PRIVACY_POLICY_ES.md`, capturada de `main` en el commit `5c51fa5` el 31/08/2026. Describe el comportamiento implementado; los cambios futuros de contacto/dominio siguen registrados en `PENDENCIAS.md`.
