> **Documentary copy — current public policy.** Source: `/PRIVACY_POLICY_EN.md`, captured from `main` at commit `5c51fa5` on 2026-08-31. It describes implemented behavior; future contact/domain changes remain tracked in `PENDENCIAS.md`.
