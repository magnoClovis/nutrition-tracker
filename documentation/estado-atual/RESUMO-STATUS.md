...
- **[Câmera embutida — C4a] Em andamento (12/09/2026) — Chat: Trofia-UIUX.** A robustez nativa/ciclo de vida adiciona permissão explícita, timeouts, retry e limpeza tardia do Camera Preview; interrupção por background e Voltar; bloqueio de orientação e estabilidade de scroll, sem zoom/flash/troca de câmera. No Galaxy físico, permissão concedida/negada, preview confinado, rotação solicitada, Home, Voltar, três ciclos de cancelamento e captura Base64 foram exercitados; todos liberaram o cliente nativo. O APK paralelo `.c4proof` foi removido e nenhum APK/AAB foi publicado. Gate local final: 105/105 focados, 1.337/1.337 unitários e cutover 60/60, todos sem skip; falta abrir o draft PR e obter CI autenticado antes de declarar a subfatia concluída.
