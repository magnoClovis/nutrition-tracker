...
- **[Câmera embutida — C3] Em andamento (12/09/2026) — Chat: Trofia-UIUX.** O draft PR #190 integra o preview traseiro ao fluxo real C24 com `toBack:true`, viewport medido, máscaras arredondadas Glass UI, controles HTML acessíveis acima da câmera, PT/EN/ES, abertura/contração e `prefers-reduced-motion`. Prova física paralela no Galaxy validou transparência localizada, cliques sobre o preview, recorte sem vazamento, cancelamento e captura Base64; o harness foi removido. Gate local: 1.328 unitários sem skip e cutover 60/60; falta o CI autenticado e a aprovação/merge do PR para declarar C3 concluída.
