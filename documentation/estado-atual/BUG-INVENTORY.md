...
não cria arquivo quando a prova falha. Gates locais e CI verdes no PR draft
#264; revisão pendente.
...
não habilita importação após contrato inválido. Gates locais e CI verdes no PR
draft #264; revisão pendente.
