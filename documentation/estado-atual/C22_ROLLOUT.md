> **Cópia documental — rollout concluído.** Fonte: `/C22_ROLLOUT.md`, capturada da `main` no commit `5c51fa5` em 31/08/2026. A matriz foi usada durante a implantação; C22 foi validado em produção e está concluído. Passos formulados no futuro dentro do corpo são o procedimento histórico, não trabalho ainda pendente.
