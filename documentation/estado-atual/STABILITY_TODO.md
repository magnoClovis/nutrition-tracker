> **Cópia documental — checklist misto.** Fonte: `/STABILITY_TODO.md`, capturada da `main` no commit `5c51fa5` em 31/08/2026. Linhas explicitamente concluídas são evidência histórica; linhas abertas são planejamento/validação pendente e não descrevem capacidades disponíveis. O original da raiz continua sendo a fonte operacional.
